...
export class ColorService {
  private apiUrl = 'http://localhost:3000/api/vehiculos/color'; // Cambia esto según tu API
  ...
  deleteById(idColor: string): Observable<any> {
    return this.http.post(`${this.apiUrl}/deleteById`, { idColor });
  }
}
